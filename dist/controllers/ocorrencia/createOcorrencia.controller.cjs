...
var createOcorrencia_controller_exports = {};
__export(createOcorrencia_controller_exports, {
  default: () => createOcorrencia_controller_default
});
module.exports = __toCommonJS(createOcorrencia_controller_exports);
